...
public class Pessoa {
	...
	public String toString() {
		return "Pessoa [id=" + id + ", nome=" + nome + ", cpf=" + cpf + ", rg=" + rg + ", dataNasc=" + dataNasc
				+ ", rua=" + rua + ", bairro=" + bairro + ", cidade=" + cidade + ", uf=" + uf + ", cep=" + cep
				+ ", email=" + email + ", senha=" + senha + ", tipo=" + tipo + ", fone1=" + fone1 + ", fone2=" + fone2
				+ "]";
	}
